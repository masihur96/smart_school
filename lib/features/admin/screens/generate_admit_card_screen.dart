...
class _GenerateAdmitCardScreenState extends State<GenerateAdmitCardScreen> {
  ...
  pw.Widget _buildHalfPageCard({
    ...
    // ── Group subjects by date (date-keyed, preserving sort order) ──────
    final Map<String, List<ExamAssignment>> groupedByDate = {};
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          // ── 2. Student photo + info + exam info ────────────────────────
          pw.Container(
          ...
          // ── 6. Signatures ──────────────────────────────────────────────
          pw.Container(
            margin: const pw.EdgeInsets.fromLTRB(14, 0, 14, 12),
            child: pw.Row(
              mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
              crossAxisAlignment: pw.CrossAxisAlignment.end,
              children: [

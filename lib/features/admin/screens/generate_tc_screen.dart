          ...
          return pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                // Content
                _buildPdfRow('1. Name of the Pupil:', student.user?.name ?? 'Unknown'),
                _buildPdfRow('2. Admission/Roll Number:', student.rollId),
                _buildPdfRow('3. Class in which pupil last studied:', className),
                _buildPdfRow('4. Section:', sectionName),
                _buildPdfRow('5. Contact Number:', student.guardianContact.isNotEmpty ? student.guardianContact : (student.user?.phone ?? 'N/A')),

      ...
      body: NestedScrollView(
        ...
        body: notifier.isLoading
            ...
            : Column(
                children: [
                  // Stats bar
                  _StatsBar(total: all.length, shown: filtered.length),
                  Expanded(
                    child: ListView.separated(
                      ...
                      itemBuilder: (ctx, i) =>
                          _StudentTile(student: filtered[i], index: i),
                    ),
                  ),
                ],
              ),
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: const [
                Icon(Icons.class_outlined, size: 12, color: Colors.white),
                SizedBox(width: 4),
                Text(
                  'Enrolled',
                  style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: active ? _kPrimary : _kPrimary.withOpacity(0.08),

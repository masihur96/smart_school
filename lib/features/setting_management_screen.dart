...
class SettingManagementScreen extends StatefulWidget {
  ...
  @override
  State<SettingManagementScreen> createState() => _SettingManagementScreenState();
}
...
class _SettingManagementScreenState extends State<SettingManagementScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.settingManagement),
      ),
      body: ListView(
        ...
        children: [
          ...
          _buildSettingTile(
            icon: Icons.language,
            title: "English / বাংলা",
            subtitle: settings.locale.languageCode == 'en' ? 'English' : 'বাংলা',
            theme: theme,
            onTap: () {
              final newLocale = settings.locale.languageCode == 'en' ? const Locale('bn') : const Locale('en');
          ...
          _buildSettingTile(
            ...
            onTap: () => Navigator.pushNamed(context, RouteGenerator.changePasswordRoute),
            theme: theme,
            isAction: true,
          ),
  ...
  Widget _buildSettingTile({
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: trailing ?? (isAction ? const Icon(Icons.chevron_right) : null),
        onTap: onTap,

class APIPath {
  ...
  static String adminMarksExam = "$baseUrl/admin/marks/exam";
  ...
  static String libraryIssuedBooks = "$baseUrl/library/issued-books";
  static String libraryReturnBook(String id) =>
      "$baseUrl/library/issued-books/$id/return";
